...
export default function GoalsSummary() {
  ...
  const urgentGoals = upcomingGoals.filter(goal => {
    ...
    return urgency === "critical" || urgency === "urgent" || urgency === "overdue";
  }).length;
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">{urgentGoals}</div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      {urgencyIcon}
                      <div>
                        <div className="text-sm font-medium">{goal.goalName}</div>
